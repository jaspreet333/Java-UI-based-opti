...
public class printingtemplatesales2 {
		...
		String t8=null;
		String t9=null;
		public printingtemplatesales2(String dos, String sid, String voucherno,
			String name, String companyname, String sp) {
	...
	private class IntroPage implements Printable {
	    ...
	    public int print(Graphics g, PageFormat pageFormat, int page) {
	     ...
	     // String titleText = "Printing in Java Part 2";
	      ...
	      g2d.drawString("SunGlasses",  20, 220);
	     ...
	     // g2d.drawString("Frame ",  20, 260);
	      ...
	      g2d.drawString(t6,  (int) pageFormat.getImageableWidth()-60, 350);
